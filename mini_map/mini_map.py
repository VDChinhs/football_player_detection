...
class MiniMap():
    ...
    def set_court_drawing_key_points(self):
        ...
        drawing_key_points[5] = self.court_start_y + self.convert_meters_to_pixels(constants.NUA_SAN_DAI*2)
        # point 3
        drawing_key_points[6] = drawing_key_points[0] + self.court_drawing_width
        drawing_key_points[7] = drawing_key_points[5] 
        # #point 4
        drawing_key_points[8] = drawing_key_points[0] +  self.convert_meters_to_pixels(constants.GOC_CAM)
        drawing_key_points[9] = drawing_key_points[1] 
        # #point 5
        drawing_key_points[10] = drawing_key_points[2] - self.convert_meters_to_pixels(constants.GOC_CAM)
        drawing_key_points[11] = drawing_key_points[3] 
        # #point 6
        drawing_key_points[12] = drawing_key_points[4] + self.convert_meters_to_pixels(constants.GOC_CAM)
        drawing_key_points[13] = drawing_key_points[5] 
        # #point 7
        drawing_key_points[14] = drawing_key_points[6] - self.convert_meters_to_pixels(constants.GOC_CAM)
        drawing_key_points[15] = drawing_key_points[7] 
        # #point 8
        drawing_key_points[16] = drawing_key_points[8] + self.convert_meters_to_pixels(constants.CAM_GOAL) 
        drawing_key_points[17] = drawing_key_points[1] 
        # # #point 9
        drawing_key_points[18] = drawing_key_points[10] - self.convert_meters_to_pixels(constants.CAM_GOAL)
        drawing_key_points[19] = drawing_key_points[1] 
        # #point 10
        drawing_key_points[20] = drawing_key_points[12] + self.convert_meters_to_pixels(constants.CAM_GOAL) 
        drawing_key_points[21] = drawing_key_points[5] 
        # # #point 11
        drawing_key_points[22] = drawing_key_points[14] - self.convert_meters_to_pixels(constants.CAM_GOAL)
        drawing_key_points[23] = drawing_key_points[5] 
        # # #point 12
        drawing_key_points[24] = drawing_key_points[8]
        drawing_key_points[25] = drawing_key_points[9] + self.convert_meters_to_pixels(constants.CAM_DAI)  
        # # #point 13
        drawing_key_points[26] = drawing_key_points[10]
        drawing_key_points[27] = drawing_key_points[11] + self.convert_meters_to_pixels(constants.CAM_DAI) 
        # # #point 14
        drawing_key_points[28] = drawing_key_points[8]
        drawing_key_points[29] = drawing_key_points[13] - self.convert_meters_to_pixels(constants.CAM_DAI)  
        # # #point 15
        drawing_key_points[30] = drawing_key_points[10]
        drawing_key_points[31] = drawing_key_points[15] - self.convert_meters_to_pixels(constants.CAM_DAI) 
        # # #point 16
        drawing_key_points[32] = drawing_key_points[16]
        drawing_key_points[33] = drawing_key_points[17] + self.convert_meters_to_pixels(constants.GOAL_DAI)  
        # # #point 17
        drawing_key_points[34] = drawing_key_points[18]
        drawing_key_points[35] = drawing_key_points[19] + self.convert_meters_to_pixels(constants.GOAL_DAI) 
        # # #point 18
        drawing_key_points[36] = drawing_key_points[16]
        drawing_key_points[37] = drawing_key_points[21] - self.convert_meters_to_pixels(constants.GOAL_DAI)  
        # # #point 19
        drawing_key_points[38] = drawing_key_points[18]
        drawing_key_points[39] = drawing_key_points[23] - self.convert_meters_to_pixels(constants.GOAL_DAI) 
        # # #point 20
        drawing_key_points[40] = drawing_key_points[0] 
        drawing_key_points[41] = drawing_key_points[1] + self.convert_meters_to_pixels(constants.NUA_SAN_DAI)  
        # # #point 21
        drawing_key_points[42] = drawing_key_points[2]
        drawing_key_points[43] = drawing_key_points[3] + self.convert_meters_to_pixels(constants.NUA_SAN_DAI) 
        # # #point 22
        drawing_key_points[44] = drawing_key_points[0] + self.convert_meters_to_pixels(constants.MID)
        drawing_key_points[45] = drawing_key_points[41]
        # # #point 23
        drawing_key_points[46] = drawing_key_points[2] - self.convert_meters_to_pixels(constants.MID)
        drawing_key_points[47] = drawing_key_points[41]
        # # #point 24
        drawing_key_points[48] = drawing_key_points[12] + self.convert_meters_to_pixels(constants.BAU_DUC)
        drawing_key_points[49] = drawing_key_points[27]   
        # # #point 25
        drawing_key_points[50] = drawing_key_points[26] - self.convert_meters_to_pixels(constants.BAU_DUC) 
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self,player_boxes, ball_boxes, original_court_key_points ):
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            for player_id, info in player_bbox.items():
                foot_position = get_foot_position(info['box'])
                closest_player_id_to_ball = min(player_bbox.keys(), key = lambda x: measure_distance(ball_position, get_center_of_bbox(info['box'])))

                # Get The closest keypoint in pixels
                closest_key_point_index = get_closest_keypoint_index(foot_position, original_court_key_points, [22,23,24,25])
                ...
                bboxes_heights_in_pixels = [get_height_of_bbox(info['box']) for i in range (frame_index_min,frame_index_max)]
